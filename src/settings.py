...
class Settings:
    def __init__(self) -> None:
        """Initialize the Settings with default configuration values including reviewers, workers, input chars, tools, quality checks, issue retries, and check_open_pr property.
        ...
        and a maximum number of issue retries (int, defaulting to 2). The check_open_pr property is added with a default value of True (bool).
