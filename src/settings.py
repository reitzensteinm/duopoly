...
class Settings:
    def __init__(self) -> None:
        ...
        """A boolean value that determines whether the system checks if there is an open pull request before applying changes.

	    By default, this value is set to True, meaning the system will check for open pull requests. To disable this check, set this property to False.
	    """
